                              ...
                              <div className="flex items-center justify-between w-full h-full px-0.5"> 
                                ...
                                <div className="flex items-center space-x-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                                  <Button
                                    variant="ghost"
                                    size="icon"
                                    className="h-5 w-5 p-0 hover:bg-blue-100 rounded-sm" // Botões um pouco maiores para clique
                                  ...
                                  <Button
                                    variant="ghost"
                                    size="icon"
                                    className="h-5 w-5 p-0 hover:bg-red-100 rounded-sm" // Botões um pouco maiores
